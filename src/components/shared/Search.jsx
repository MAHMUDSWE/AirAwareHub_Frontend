...
export default function SearchBar() {
    ...
    const { data: city } = useQuery({
        ...
        queryFn: async () => await CityService.getListOfCities(searchText),
        staleTime: 15000
    });
    ...
    return (
        <div className="relative bg-white mb-4 container max-w-4xl mx-auto px-4 py-4">
            <div
            ...
            {isFocused && searchText.length <= 0 && (
                <div
                    ...
                    <span className='text-lg'>Try searching for cities or states</span>
                </div>
            )}
        </div>
    );
